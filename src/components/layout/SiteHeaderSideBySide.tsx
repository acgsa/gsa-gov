...
/**
 * SiteHeaderSideBySide — PRODUCTION desktop topbar
 * ------------------------------------------------
 ...
 *
 * This variant is wired into `src/app/(frontend)/layout.tsx` as the active
 * public header (approved by the project owner on 2026-07-27). The previous
 * stacked layout remains in the 🔒 LOCKED `SiteHeader.tsx` for reference.
 *
 * Scroll behavior mirrors the locked SiteHeader.tsx: a single persistent row
 * whose padding/seal/title continuously shrink via scroll-linked motion
 * values (useTransform), rather than swapping between two discrete markups.
 * Date/weather, the seal + wordmark, and Log in all stay mounted and visible
 * throughout — nothing disappears and reappears.
 */
...
export function SiteHeaderSideBySide() {
