...
export default function ContactPage() {
  return (
    <InfoPage
      ...
      title="Contact & FOIA"
      intro="Whether you&rsquo;re a federal agency looking for support, a vendor with a contracting question, or a member of the public, here&rsquo;s how to reach the right team at GSA."
      sections={[
        {
          id: "contact",
          heading: "Contact GSA",
      ...
      related={[
        ...
        { label: "How we're organized", href: "/about/organization" },
      ]}
    />
  );
}
