...
export const metadata: Metadata = {
  title: "1800 F Street Revitalization — Live Construction Camera | GSA",
  description:
    "Watch a live construction camera feed of the 1800 F Street NW revitalization project — GSA's flagship federal workplace transformation in Washington, D.C.",
};
    ...
    body: (
      <ul className="space-y-4">
        <li className="flex items-start gap-3">
          ...
          <span>
            <strong>Phase 1 — Complete (2024)</strong>
            <br />
    ...
    body: (
      <>
        ...
        <p>
          ...
          updates alongside the live camera. Weekly archived footage, project
          documents, and budget data are available on the&nbsp;
          <a
            href="/initiatives/1800f"
...
export default function LivestreamPage() {
  return (
    <>
      {/* ── Theater-mode video (replaces ParallaxHero — no parallax) ──
          A full-viewport-width black band. The 16:9 iframe sits centred inside
          it at the same max-width used by article content (600px body + gutters)
          but widened slightly for cinematic impact. Black fills the sides
          automatically because the outer band is bg-black. */}
      <div className="w-full bg-black">
        <div className="mx-auto w-full max-w-5xl">
          <TheaterVideo
            src="https://www.youtube.com/embed/X74hqPDTZwM"
            title="Live construction camera — 1800 F Street NW revitalization, Phase 2"
            showLiveBadge
      ...
      <DetailPage
        ...
        eyebrowHref="/initiatives/1800f"
        title="1800 F Street Revitalization — Live Construction Camera"
        ...
        relatedLinks={[
          {
            label: "1800 F Street Revitalization — Project Overview",
            href: "/initiatives/1800f",
            category: "Initiative",
          },
          {
